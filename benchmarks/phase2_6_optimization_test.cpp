...
// Wrappers that match the function-pointer signature.
...
int main() {
    ...
    std::cout << "Size   naive(ms)  reorder(ms)  blocked(ms)  blockedTrans(ms)  simdReorder(ms)\n";
    for(auto n : sizes){
